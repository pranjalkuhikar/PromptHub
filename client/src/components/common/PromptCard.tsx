...
const PromptCard: React.FC<PromptCardProps> = ({ id, prompt, tags, userId, showActions, currentUserId }) => {
  ...
  const isOwner = currentUserId && userId && userId.username === currentUserId;
